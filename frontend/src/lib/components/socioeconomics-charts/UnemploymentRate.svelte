<script>
  ...
  function prepareChartData() {
    ...
    const years = [
      { label: '2019-20', column: 'Master sheet2_Jul19-20UEP' },
      { label: '2020-21', column: 'Master sheet2_Jul20-21UEP' },
      { label: '2021-22', column: 'Master sheet2_Jul21-Jun22UEP' },
      { label: '2022-23', column: 'Master sheet2_Jul22-Jun23UEP' },
      { label: '2023-24', column: 'Master sheet2_Jul23-Jun24UEP' },
      { label: '2024-25', column: 'Master sheet2_Jul24-Jun25UEP' }
    ];
