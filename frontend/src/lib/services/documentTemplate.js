...
export const DocumentConfig = {
  // Typography - Calibri Light throughout
  fonts: {
    family: 'Calibri Light',
    title: { size: 18, bold: false, family: 'Calibri Light' },
    subtitle: { size: 14, bold: false, family: 'Calibri Light' },
    heading1: { size: 14, bold: false, family: 'Calibri Light' },
    heading2: { size: 12, bold: false, family: 'Calibri Light' },
    heading3: { size: 11, bold: false, family: 'Calibri Light' },
    body: { size: 10, bold: false, family: 'Calibri Light' },
    bodyBold: { size: 10, bold: true, family: 'Calibri Light' },
    caption: { size: 9, italic: true, family: 'Calibri Light' },
    small: { size: 9, bold: false, family: 'Calibri Light' },
  },
